...
from streamlit_app.utils.transfromer_utils import load_model, unload_model, get_list_of_models
import asyncio
...
async def process_page():
    ...
    selected_unload_models = st.selectbox("Выберите модель для выгрузки из инференса", await get_status())
